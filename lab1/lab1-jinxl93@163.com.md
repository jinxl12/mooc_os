...
bin/ucore.img
| 生成ucore.img的相关代码为Makefile文件的第169行到第175行。代码如下：
|# create ucore.img
...
|
| 为了生成ucore.img，需要生成kernel、bootblock。
|
|>	bin/kernel
|	| 生成kernel的相关代码如下（Makefile文件的第133行到第139行）：
...
|
|>	bin/bootblock
|	| 生成bootblock的相关代码如下（Makefile文件的第151行到第157行）：
...
|	|
|	| 为了生成bootblock，需要先生成bootasm.o、bootmain.o、sign
|	|
|	|>	obj/boot/bootasm.o, obj/boot/bootmain.o
|	|	| 生成bootasm.o,bootmain.o的相关makefile代码如下（Makefile文件的第146行到第147行）：
...
|	|
|	|>	bin/sign
|	|	| 生成sign工具的makefile代码如下（Makefile文件的第163行到第165行）：
|       |       | # create 'sign' tools
